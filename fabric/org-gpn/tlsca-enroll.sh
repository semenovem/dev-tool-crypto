...
# ---
MSP_DIR="${__CRYPTO_PEER__}/${ORG}/peers/peer0.gpn.ru/tls"
dir-empty "$MSP_DIR" && (
...
# ---
MSP_DIR="${__CRYPTO_PEER__}/${ORG}/peers/peer1.gpn.ru/tls"
dir-empty "$MSP_DIR" && (
...
# ---
MSP_DIR="${__CRYPTO_PEER__}/${ORG}/users/Admin@gpn.ru/tls"
dir-empty "$MSP_DIR" && (

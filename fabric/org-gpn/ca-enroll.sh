...
MSP_DIR="${__CRYPTO_PEER__}/${ORG}/peers/peer0.gpn.ru/msp"
dir-empty "$MSP_DIR" && (
...
MSP_DIR="${__CRYPTO_PEER__}/${ORG}/peers/peer1.gpn.ru/msp"
dir-empty "$MSP_DIR" && (
...
MSP_DIR="${__CRYPTO_PEER__}/${ORG}/users/Admin@gpn.ru/msp"
dir-empty "$MSP_DIR" && (
...
MSP_DIR="${__CRYPTO_PEER__}/${ORG}/users/User1@gpn.ru/msp"
dir-empty "$MSP_DIR" && (
...
# --- gpn
MSP_DIR="${__CRYPTO_PEER__}/${ORG}/msp"

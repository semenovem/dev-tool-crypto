...
fabric-ca-client register --id.name peer0.vtb.ru --id.secret peer0PW || exit 1

fabric-ca-client register --id.name peer1.vtb.ru --id.secret peer1PW || exit 1

fabric-ca-client register --id.name Admin@vtb.ru --id.secret AdminPW || exit 1
